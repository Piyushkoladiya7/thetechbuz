...
const VolcanicEruptions = () => {
    return (
        <>
            <Container>
                <Row className='mb-5'>
                    <Col lg={8} className="mt-5">
                        <img src='./assets/image/volcanic-eruptions.jpg' alt='' width="100%" />
                        <div className='detail-content'>
                            <button className='science-btn'>Science</button>
                            <h1 className='detail-header'>How Volcanic Eruptions Caused Numerous Chinese Dynasties To Crumble Over The Last 2,000 Years</h1>
