            ...
            <Container>
                <Row className='mb-5'>
                    <Col lg={8} className="mt-5">
                        <img src='./assets/image/Strike-rages-img.jpg' alt='' width="100%" />
                        <div className='detail-content'>
                            <button className='wealth-btn'>Wealth</button>
                            <h1 className='detail-header'>Labors got fired; Strike rages</h1>
                            <div className='detail-body'>
                                ...
                                <br />
                                <img src="./assets/image/Strike-rages-img-2.jpg" alt="" width="100%" />
