            ...
            <Container>
                <Row className='mb-5'>
                    <Col lg={8} className="mt-5">
                        <img src='./assets/image/SamsungJet.jpg' alt='' width="100%" />
                        <div className='detail-content'>
                            <button className='tech-btn'>Tech</button>
                            <h1 className='detail-header'>Samsung’s Jet Bot AI+ Robot Vacuum Is Necessary For Pet Lovers</h1>
