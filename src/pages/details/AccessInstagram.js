...
const AccessInstagram = () => {
    return (
        <>
            <Container>
                <Row className='mb-5'>
                    <Col lg={8} className="mt-5">
                        <img src='./assets/image/accessinstagram.jpg' alt='' width="100%" />
                        <div className='detail-content'>
                            <button className='tech-btn'>Tech</button>
                            <h1 className='detail-header'>Access Instagram’s ‘On This Day’ Feature; Simple Steps</h1>
